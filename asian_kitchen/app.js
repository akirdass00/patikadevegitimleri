...
// Butonların ve menünün bulunduğu kısmın class'ınnı seçiyoruz.
const btnContainer = document.querySelector('.btn-container')
const menuSection = document.querySelector('.section-center')



//butonu oluşturup btn değişkeninin içine bootstrap'tan aldığımız Dark butonu yerleştiriyoruz.
function createButton(buttonName) {
  let btn =`<button type="button" id="${buttonName}" class="btn btn-outline-dark">${buttonName}</button>`
  return btn
}
// Butona tıklandığında nereye ulaşacağını belirtiyoruz.
function addBtn() {
...
//Bu fonksiyon ile Yemekleri ülkelere göre filtreleyip kulanıcıya gösteriyoruz.
function addFoodAll(){
